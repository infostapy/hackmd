...
窓口スタッフは「[発表者への依頼文章のテンプレート](https://github.com/infostapy/hackmd/blob/main/Contact_speaker_template.md)」を使って確認する
...
~~~
12/9 19:00開始「みんなのPython勉強会65」配信URLのご連絡
~~~

#### 件名（当日の夕方18:30ごろ）

~~~
12/9 19:00開始「みんなのPython勉強会#65」配信URLのご連絡（リマインダー）
~~~
